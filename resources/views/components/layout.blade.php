...
<head>
	...
	<!--favicon-->
	<link rel="icon" href="{{url('frontend/assets/images/favicon-32x32.')}}" type="image/png"/>
	<!--plugins-->
	<link href="{{url('frontend/assets/plugins/vectormap/jquery-jvectormap-2.0.2.css')}}" rel="stylesheet"/>
	<link href="{{url('frontend/assets/plugins/simplebar/css/simplebar.css')}}" rel="stylesheet" />
	<link href="{{url('frontend/assets/plugins/perfect-scrollbar/css/perfect-scrollbar.css')}}" rel="stylesheet" />
	<link href="{{url('frontend/assets/plugins/metismenu/css/metisMenu.min.css')}}" rel="stylesheet"/>
	<!-- loader-->
	...
	<link href="{{url('frontend/assets/css/bootstrap-extended.css')}}" rel="stylesheet">
	<link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500&amp;display=swap" rel="stylesheet">
	<link href="{{url('frontend/assets/css/app.css')}}" rel="stylesheet">
	<link href="{{url('frontend/assets/css/icons.css')}}" rel="stylesheet">
	<!-- Theme Style CSS -->
	<link rel="stylesheet" href="{{url('frontend/assets/css/dark-theme.css')}}"/>
	<link rel="stylesheet" href="{{url('frontend/assets/css/semi-dark.css')}}"/>
	<link rel="stylesheet" href="{{url('frontend/assets/css/header-colors.css')}}"/>
	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				<div>
					<img src="{{url('frontend/assets/images/logo-icon.png')}}" class="logo-icon" alt="logo icon">
				</div>
				<div>
                    ...
                    <li> <a href="Vgallery"><i class='bx bx-radio-circle'></i> Gallery</a>
                        ...
                        <li>
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                @if(Session::has('new_contacts_count'))
                                    <div class="new-contact-notification bg-danger text-white rounded-circle">
                                        {{ session('new_contacts_count') }}
                                        <script>
                                            document.getElementById('seeUserContactsLink').addEventListener('click', function() {
                                                @php
				...
				<nav class="navbar navbar-expand gap-3">
					...
					{{-- <div class="user-box dropdown px-3"> --}}
						{{-- <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> --}}
							{{-- <img src="{{url('frontend/assets/images/avatars/avatar-2.')}}')}}" class="user-img" alt="user avatar"> --}}
							{{-- <div class="user-info"> --}}
...
@endif
	...
	<script src="{{url('frontend/assets/plugins/perfect-scrollbar/js/perfect-scrollbar.js')}}"></script>
	<script src="{{url('frontend/plugins/vectormap/jquery-jvectormap-2.0.2.min.js')}}"></script>
    <script src="{{url('frontend/plugins/vectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
	<script src="{{url('frontend/plugins/chartjs/js/chart.js')}}"></script>
	<script src="{{url('frontend/plugins/sparkline-charts/jquery.sparkline.min.js')}}"></script>
	<script src="{{url('frontend/assets/plugins/jquery.easy-pie-chart/jquery.easypiechart.min.js')}}"></script>
	<script src="{{url('frontend/assets/plugins/jquery-knob/excanvas.js')}}"></script>
	<script src="{{url('frontend/assets/plugins/jquery-knob/jquery.knob.js')}}"></script> -
	<script>
		  $(function() {
			  $(".knob").knob();
		  });
	</script>
	{{-- <script src="{{url('frontend/assets/js/index.js')}}"></script> --}}
	<!--app JS-->
