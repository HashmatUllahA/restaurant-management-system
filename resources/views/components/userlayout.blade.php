                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-3 display-flex flex-center">
                        <div class="header-logo transition">
                            <a href="http://themes.templatescoder.com/restaurano/html/demo/1-0/index.html"><img src="{{url('frontend/assets/User/kprlogo.png')}}" alt="Restaurano Logo"></a>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-xl-5 col-lg-5 col-md-4">
                                <div class="footer-logo-part">
                                    <a href="http://themes.templatescoder.com/restaurano/html/demo/1-0/index.html"><img src="{{url('frontend/assets/User/kprlogo.png')}}" class="logo-icon" alt="logo icon"></a>
