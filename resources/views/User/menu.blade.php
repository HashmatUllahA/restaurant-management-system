                        ...
                        <div class="menu-tabbing position-r">
                            ...
                            <div class="tab-content wow fadeInUp">
                                <div role="tabpanel" class="tab-pane fade in active show" id="all_items">
                                    <div class="row">
                                        @foreach($allmenudeta as $item)
                                            <div class="col-xl-6 col-lg-6 col-md-6">
                                                <div class="menu-box">
                                                    <a href="#" class="iteam-name">{{ $item->foodname }}</a>
                                                    <span class="iteam-price">${{ $item->foodprice }}</span>
                                                    <p class="iteam-desc">{{ $item->explanation }}</p>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
