                            ...
                            <?php else: ?>
                                <?php $__currentLoopData = $order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($data->mobilenumber); ?></td>
                                        <td><?php echo e($data->address); ?></td>
                                        <td><?php echo e($data->fooditeams); ?></td>
                                        <td><?php echo e($data->message); ?></td>
                                        <td>
                                            <form action="<?php echo e(route('delete.order', ['id' => $data->id])); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH J:\kpr\resources\views/Admin/ORDER/checkorder.blade.php ENDPATH**/ ?>