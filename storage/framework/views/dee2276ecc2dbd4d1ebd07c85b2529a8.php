        ...
        <div class="page-wrapper">
			<div class="page-content">
                    ...
                    <table id="customerTable" class="table table-hover">
                        ...
                        <tbody>
                            <?php if($customerRecordsToday->isEmpty()): ?>
                                <tr>
                                    <td colspan="5">No records available</td>
                                </tr>
                            <?php else: ?>
                                <?php $__currentLoopData = $customerRecordsToday; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
...
<script>
    ...
    $('#addoncash').submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(route("submitoncash")); ?>',
            data: formData,
...
<?php endif; ?>
<?php /**PATH J:\kpr\resources\views/Admin/oncashcustomer/index.blade.php ENDPATH**/ ?>