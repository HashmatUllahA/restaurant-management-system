...
<head>
    ...
    <title>monthy curd</title>
</head>
<body>

    <table id="" class="table table-hover">
        <h5 class="text-center">Monthly miss curd Records</h5>
        <thead>
            <tr>
                <th>DATE:</th>
                <th>DATIELS:</th>
    ...
    <td><?php echo e($cost->food); ?></td>
    <td><?php echo e($cost->foodprice); ?></td>
...
<?php endif; ?>
        ...
        <tr>
            ...
            <td><?php echo e($totalcurdMoney); ?></td>
        </tr>
    </table>
</body>
</html>
<?php /**PATH J:\kpr\resources\views/Admin/monthly_curd.blade.php ENDPATH**/ ?>